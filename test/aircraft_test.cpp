...
int main(int argc, char *argv[]){
    ...
    submodels_TOP = {input_reader, myAircraft};
    ...
    eocs_TOP = {
        dynamic::translate::make_EOC<Aircraft_defs::outAircraftPosition,top_out>("myAircraft")
    };
    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<messageMissileStatus>::out,Aircraft_defs::inMissileStatus>("input_reader","myAircraft")
    };
